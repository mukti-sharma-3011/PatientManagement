...
import com.admission.hospital.PatientManagement.payloads.JwtAuthRequest;
import com.admission.hospital.PatientManagement.payloads.JwtAuthResponse;
...
import com.admission.hospital.PatientManagement.security.JwtHelper;
...
public class AuthController {
    ...
    public ResponseEntity<StaffDto> addStaff(@RequestBody StaffDto staffDto ) {
    	StaffDto addedStaff=staffService.addStaffMember(staffDto);
